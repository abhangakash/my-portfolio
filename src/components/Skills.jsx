...
export default function Skills() {
  ...
  const problemSolving = [
    { platform: "LeetCode", solved: "300+", rank: "Top 10%", link: "https://leetcode.com/u/akashabhang/", color: "text-amber-700" },
    ...
    { platform: "Total Solved", solved: "600+", rank: "Across Different Platforms", link: "#", color: "text-orange-700" }
  ];
